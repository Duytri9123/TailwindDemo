<template>
  <section class="w-8/9 lg:w-6/8 grid lg:grid-cols-2 grid-cols-1 gap-10 lg:gap-0">
      ...
      <div class="flex flex-col justify-center w-full md:px-8 p-1 lg:py-4">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="text-gray-600 tracking-[0.5px] text-sm md:text-base">
              ...
              Pulvinar nisl et suspendisse velit ornare sed dolor, convallis dolor. Et,
              dignissim amet sed orci at amet id nulla mauris.
            </p>
          </div>
          <div>
            <h6 class="font-medium text-base md:text-lg text-gray-900">
      ...
      <div class="flex flex-col justify-center w-full md:px-8 p-1 lg:my-4">
        <h1 class="text-lg md:text-xl lg:text-3xl xl:text-[32px] font-medium mb-4 ">
        ...
        <div class="space-y-4">
          ...
          <p class="text-gray-600 tracking-[0.5px] text-sm md:text-base">
            ...
            et suspendisse velit ornare sed dolor, convallis dolor. Et, dignissim amet sed
          ...
          <p class="text-gray-600 tracking-[0.5px] text-sm md:text-base">
            ...
            Malesuada morbi nisl cras turpis pretium. Habitant facilisis malesuada
            suscipit mus
          </p>
        </div>
      </div>
