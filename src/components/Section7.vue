<template>
  <section
    class="w-8/9 lg:w-6/8 grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:gap-8 gap-4"
  >
    <div
...
const originalUrl =
  "https://www.youtube.com/watch?v=2Z-N3AxPJwM&list=RD2Z-N3AxPJwM&start_radio=1";
